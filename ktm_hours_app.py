...
# --- From/To Date selector for weekly summary ---
st.markdown("## 📅 Select Date Range for Weekly Summary")
...
if df.empty:
    ...
    # Use the date range to filter rows (optional if you store dates, else just keep all)
    summary_data = []
    for emp in employees:
        row = {"Employee": emp}
        total_hours = 0
